...
base_expr_assignable
	: BUILTIN CONST_IDENT
	| BUILTIN IDENT
	| path ident_expr opt_generic_parameters
...
bitstruct_declaration
	: BITSTRUCT TYPE_IDENT opt_interface_impl ':' type_non_generic opt_attributes bitstruct_body
	;
...
struct_member_decl
	...
	| BITSTRUCT ':' type_non_generic opt_attributes bitstruct_body
	| BITSTRUCT IDENT ':' type_non_generic opt_attributes bitstruct_body
...
enum_spec
	: ':' base_type_non_generic '(' enum_params ')'
	| ':' INLINE base_type_non_generic '(' enum_params ')'
	| ':' base_type_non_generic
	| ':' INLINE base_type_non_generic
	| ':' '(' enum_params ')'
	;
