...
static const char *win_subsystem[9] = {
	...
	[WIN_SUBSYSTEM_BOOT_APPLICATION] = "BOOT_APPLICATION",
	[WIN_SUBSYSTEM_EFI_APPLICATION] = "EFI_APPLICATION",
	[WIN_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER] = "EFI_BOOT_SERVICE_DRIVER",
	[WIN_SUBSYSTEM_EFI_ROM] = "EFI_ROM",
	[WIN_SUBSYSTEM_EFI_RUNTIME_DRIVER] = "EFI_RUNTIME_DRIVER"
};
