...
void test128()
{
    ...
    TEST_ASSERTF(addres.high == 0x345 && addres.low == 0x456, "i128 add failed with small numbers was %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    ...
    TEST_ASSERTF(addres.high == 0x123 && addres.low == 0x124, "i128 sub failed with small numbers was %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    addres = i128_sub(i128(0x346, 0), i128(0x222, 0x1));
    TEST_ASSERTF(addres.high == 0x123 && addres.low == UINT64_MAX, "i128 sub failed with simple overflow %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    ...
    TEST_ASSERTF(addres.high == UINT64_MAX && addres.low == UINT64_MAX, "i128 sub failed with wrap %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    ...
    TEST_ASSERTF(addres.high == 0x0FAFCFEF2F3F && addres.low == 0xF0F0F2F4F6F8FA, "Or failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Or - Ok.\n");
    ...
    TEST_ASSERTF(addres.high == 0x0FA4C2E02d3c && addres.low == 0xF0F0e2c4a6886A, "Xor failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Xor - Ok.\n");
    ...
    TEST_ASSERTF(addres.high == ~(uint64_t)0xabcdef2233 && addres.low == ~(uint64_t)0x1234567899,
                 "Neg failed %llx, %llx", (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Neg - Ok.\n");
    ...
    TEST_ASSERTF(addres.high == 0x222 && addres.low == 0x444, "Mult failed %llx, %llx", (unsigned long long)addres.high,
                 (unsigned long long)addres.low);
    addres = i128_mult(i128(0x111, 0x222), i128(2, 0));
    TEST_ASSERTF(addres.high == 0x444 && addres.low == 0, "Mult failed %llx, %llx", (unsigned long long)addres.high,
                 (unsigned long long)addres.low);
    addres = i128_mult(i128_from_str("523871293871232000123"), i128_from_str("283712312938293299"));

    TEST_ASSERTF(i128_ucomp(i128_from_str("148628736466183585621117368965778075777"), addres) == CMP_EQ,
                 "Mult failed %llx, %llx", (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Mult ok.\n");

    TEST_ASSERTF(i128_ucomp(i128_from_str("123"), i128_from_str("123")) == CMP_EQ, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128_from_str("123"), i128_from_str("124")) == CMP_LT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128_from_str("123"), i128_from_str("121")) == CMP_GT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128(0x222, 0x111), i128(0x111, 0x222)) == CMP_GT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128(0x111, 0x222), i128(0x222, 0x111)) == CMP_LT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128(0x222, 0x111), i128(0x222, 0x111)) == CMP_EQ, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128(UINT64_MAX, 0x111), i128(0x111, 0x222)) == CMP_GT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_ucomp(i128(0x111, 0x222), i128(UINT64_MAX, 0x111)) == CMP_LT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Ucomp ok.\n");

    TEST_ASSERTF(i128_scomp(i128_from_str("123"), i128_from_str("123")) == CMP_EQ, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128_from_str("123"), i128_from_str("124")) == CMP_LT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128_from_str("123"), i128_from_str("121")) == CMP_GT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128(0x222, 0x111), i128(0x111, 0x222)) == CMP_GT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128(0x111, 0x222), i128(0x222, 0x111)) == CMP_LT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128(0x222, 0x111), i128(0x222, 0x111)) == CMP_EQ, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128(UINT64_MAX, 0x111), i128(0x111, 0x222)) == CMP_LT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    TEST_ASSERTF(i128_scomp(i128(0x111, 0x222), i128(UINT64_MAX, 0x111)) == CMP_GT, "Comp failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    ...
    TEST_ASSERTF(addres.high == 0x23 && addres.low == 0x4000000000012345, "lshr failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    ...
    TEST_ASSERTF(addres.high == 0 && addres.low == 0x234, "lshr failed %llx, %llx", (unsigned long long)addres.high,
                 (unsigned long long)addres.low);
    printf("-- i128 Lshr ok.\n");

    addres = i128_ashr(i128(0x234, 0x123456), i128(0, 0x4));
    TEST_ASSERTF(addres.high == 0x23 && addres.low == 0x4000000000012345, "ashr failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    addres = i128_ashr(i128(0xF000000000000234, 0x123456), i128(0, 0x4));
    TEST_ASSERTF(addres.high == 0xFF00000000000023 && addres.low == 0x4000000000012345, "ashr failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    ...
    TEST_ASSERTF(addres.high == 0 && addres.low == 0x234, "ashr failed %llx, %llx", (unsigned long long)addres.high,
                 (unsigned long long)addres.low);
    addres = i128_ashr(i128(0xF000000000000234, 0x1234561), i128(0, 64));
    TEST_ASSERTF(addres.high == UINT64_MAX && addres.low == 0xF000000000000234, "ashr failed %llx, %llx",
                 (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Ashr ok.\n");

    TEST_ASSERT(i128_ucomp(i128_udiv(i128_from_str("123"), i128_from_str("123")), i128_from_str("1")) == CMP_EQ,
                "Div failed");
    TEST_ASSERT(i128_ucomp(i128_udiv(i128_from_str("123"), i128_from_str("124")), i128_from_str("0")) == CMP_EQ,
                "Div failed");
    TEST_ASSERT(i128_ucomp(i128_udiv(i128_from_str("245"), i128_from_str("123")), i128_from_str("1")) == CMP_EQ,
                "Div failed");
    ...
    TEST_ASSERTF(addres.low == UINT64_MAX && addres.high == UINT64_MAX, "Div failed %s",
                 i128_to_string(addres, 10, true));
    addres = i128_sdiv(i128(2, 0), i128(UINT64_MAX - 1, UINT64_MAX - 1));
    printf("-- i128 Div okfefe %x.\n", (unsigned)-2);
    TEST_ASSERTF(addres.low == UINT64_MAX && addres.high == UINT64_MAX, "Div failed: %s %llx, %llx",
                 i128_to_string(addres, 10, true), (unsigned long long)addres.high, (unsigned long long)addres.low);
    printf("-- i128 Div ok.\n");
}
