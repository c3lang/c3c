...
bool try_consume(Context *context, _TokenType type);
bool consume(Context *context, _TokenType type, const char *message, ...);
...
static inline bool tok_is(Context *context, _TokenType type)
{
	return context->tok.type == type;
}

static inline bool expect(Context *context, _TokenType token_type)
{
...
static inline bool token_is_some_ident(_TokenType token_type)
{
	switch (token_type)
	{
...
static inline bool token_is_keyword(_TokenType token_type)
{
