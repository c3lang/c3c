...
bool sema_analyze_decls_for_stage(CompilationUnit *unit, AnalysisStage* stage, AnalysisStage max_stage, Decl **decls, Decl **cond_decls)
{
RETRY:
	AnalysisStage current_stage = *stage;
	if (current_stage > max_stage) return false;
