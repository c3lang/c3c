...
typedef enum
{
	WIN_SUBSYSTEM_DEFAULT = -1,
	WIN_SUBSYSTEM_CONSOLE = 0,
	WIN_SUBSYSTEM_WINDOWS = 1,
	WIN_SUBSYSTEM_NATIVE = 2,
	WIN_SUBSYSTEM_POSIX = 3,
	WIN_SUBSYSTEM_BOOT_APPLICATION = 4,
	WIN_SUBSYSTEM_EFI_APPLICATION = 5,
	WIN_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER = 6,
	WIN_SUBSYSTEM_EFI_ROM = 7,
	WIN_SUBSYSTEM_EFI_RUNTIME_DRIVER = 8,
} WinSubsystem;
...
typedef enum
{
	...
	TYPE_PROPERTY_GENERIC_ARGS,
	TYPE_PROPERTY_GENERIC_QNAME,
	TYPE_PROPERTY_HAS_EQUALS,
	TYPE_PROPERTY_IS_ORDERED,
	TYPE_PROPERTY_IS_ANONYMOUS,
	TYPE_PROPERTY_IS_NESTED,
	TYPE_PROPERTY_IS_SUBSTRUCT,
	TYPE_PROPERTY_IS_GENERIC,
	TYPE_PROPERTY_LEN,
...
#define CT_TYPE_KEYWORD_TOKENS TOKEN_CT_TYPEOF: case TOKEN_CT_TYPEFROM
#define CT_TYPE_TOKENS CT_TYPE_KEYWORD_TOKENS: case TOKEN_CT_TYPE_IDENT
#define TYPELIKE_TOKENS TYPE_TOKENS: case TOKEN_TYPE_IDENT: case CT_TYPE_TOKENS
#define TOP_LEVEL_KEYWORD_TOKENS CT_TYPE_KEYWORD_TOKENS: case TOKEN_ALIAS: \
case TOKEN_ATTRDEF: case TOKEN_BITSTRUCT: case TOKEN_INTERFACE: case TOKEN_CONST: \
case TOKEN_ENUM: case TOKEN_CONSTDEF: case TOKEN_FAULTDEF: case TOKEN_STATIC: case TOKEN_EXTERN: \
case TOKEN_FN: case TOKEN_IMPORT: case TOKEN_MODULE: case TOKEN_STRUCT: case TOKEN_TYPEDEF: \
case TOKEN_UNION: case TOKEN_MACRO: case TOKEN_CT_ASSERT: case TOKEN_TLOCAL: case TOKEN_CT_ECHO: \
case TOKEN_CT_ERROR: case TOKEN_CT_EXEC: case TOKEN_CT_EXPAND: case TOKEN_CT_INCLUDE
