...
typedef enum
{
	STACK_PROTECTOR_NOT_SET = -1,
	STACK_PROTECTOR_NONE = 0,
	STACK_PROTECTOR_BASIC = 1,
	STACK_PROTECTOR_STRONG = 2,
	STACK_PROTECTOR_ALL = 3,
} StackProtector;
...
typedef enum
{
	...
	ATTRIBUTE_WEAKLINK,
	ATTRIBUTE_WINMAIN,
	ATTRIBUTE_STACKPROBE,
	ATTRIBUTE_NOSTACKPROBE,
	ATTRIBUTE_STACKPROTECTOR,
	ATTRIBUTE_NOSTACKPROTECTOR,
	ATTRIBUTE_NONE,
