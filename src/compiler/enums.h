...
typedef enum
{
	...
	INTROSPECT_TYPE_STRUCT = 9,
	INTROSPECT_TYPE_UNION = 10,
	INTROSPECT_TYPE_BITSTRUCT = 11,
	INTROSPECT_TYPE_FUNC = 12,
	INTROSPECT_TYPE_OPTIONAL = 13,
	INTROSPECT_TYPE_ARRAY = 14,
	INTROSPECT_TYPE_SLICE = 15,
	INTROSPECT_TYPE_VECTOR = 16,
	INTROSPECT_TYPE_DISTINCT = 17,
	INTROSPECT_TYPE_POINTER = 18,
	INTROSPECT_TYPE_INTERFACE = 19,
} IntrospectType;
