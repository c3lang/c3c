...
const char *kw_malloc;
const char *kw_calloc;
const char *kw_realloc;
const char *kw_free;
const char *kw_aligned_alloc;
const char *kw_name;
...
#define KW_DEF(x) symtab_add(x, sizeof(x) - 1, fnv1a(x, sizeof(x) - 1), &type)
	...
	kw_main = KW_DEF("main");
	kw_malloc = KW_DEF("malloc");
	kw_calloc = KW_DEF("calloc");
	kw_realloc = KW_DEF("realloc");
	kw_free = KW_DEF("free");
	kw_aligned_alloc = KW_DEF("aligned_alloc");
